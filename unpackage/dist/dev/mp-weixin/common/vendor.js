...
/* 3 */
/*!***********************************************************************!*\
  !*** C:/Users/ze451/Documents/agnes_projext/quiz-frontend/pages.json ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
function flushCallbacks$1(vm) {
    if (vm.__next_tick_callbacks && vm.__next_tick_callbacks.length) {
        if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"quiz-frontend","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var composition_api_1 = __webpack_require__(/*! @vue/composition-api */ 14);
var app = __webpack_require__(/*! ./app */ 16);
var mp = __webpack_require__(/*! ./mp */ 17);
var uts_1 = __webpack_require__(/*! ./uts */ 18);
...
if (false) {} else {
  module.exports = __webpack_require__(/*! ./dist/vue-composition-api.common.js */ 15)
}
...
var utils_1 = __webpack_require__(/*! ./utils */ 40);
var callbackId = 1;
var proxy;
var callbacks = {};
...
/* 50 */
/*!*************************************************************************!*\
  !*** C:/Users/ze451/Documents/agnes_projext/quiz-frontend/utils/api.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function updateUserInfo(userId, nickname, avatar) {
  return request('/wx/updateUserInfo', 'POST', {
    userId: userId,
    nickname: nickname,
    avatar: avatar
  });
...
function startQuiz(userId) {
  return request('/quiz/start', 'POST', {
    userId: userId
  });
}
...
function createUser(openid, nickname, avatar) {
  return request('/admin/createUser', 'POST', {
    openid: openid,
    nickname: nickname,
    avatar: avatar
  });
